      ...
      >
        <div className="relative px-3 pb-4 pt-3">
          <div className="absolute left-3 top-3">
            <HeaderTopPill
              icon={<Eye size={18} variant="Linear" color="#fff" />}
          ...
          {resume.resume_number != null ? (
            <div className="absolute right-3 top-3">
              <HeaderTopPill
                icon={<Barcode size={18} variant="Linear" color="#fff" />}
          ...
          <div className="flex flex-col items-center justify-center pt-6">
            ...
            <div className="mt-[10px] flex flex-wrap justify-center gap-2 px-2">
              <HeaderChip
                icon={<Briefcase size={18} variant="Linear" color="#fff" />}
                text={headerExperienceText}
              />
              <HeaderChip
                icon={<Book size={18} variant="Linear" color="#fff" />}
            ...
            <div className="min-w-0">
              {createdLabel ? (
                <div className="inline-flex items-center gap-1">
                  <Calendar2 size={18} variant="Linear" color="#9CA3AF" />
