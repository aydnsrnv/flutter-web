...
interface EmployerStatsDashboardProps {
  jobs: EmployerJobStat[];
  totalViews: number;
  totalApplied: number;
  jobsCount: number;
}
...
export function EmployerStatsDashboard({
  jobs,
  totalViews,
  totalApplied,
  jobsCount,
}: EmployerStatsDashboardProps) {
  const { t } = useI18n();
            ...
            <div className="h-[220px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailyData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="colorEmpCount" x1="0" y1="0" x2="0" y2="1">
